...
echo "          2) verify:  uv run --python $SKILL_ROOT/.venv/bin/python $SKILL_ROOT/scripts/run_test.py --list-providers"
echo "          3) optional web console: bash $SKILL_ROOT/scripts/console.sh start"
